<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
    <defs>
      ...
      >
        <stop offset=".72" stopOpacity="0"></stop>
        <stop offset=".95" stopOpacity=".53"></stop>
        <stop offset="1"></stop>
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset=".76" stopOpacity="0"></stop>
        <stop offset=".95" stopOpacity=".5"></stop>
        <stop offset="1"></stop>
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#35C1F1"></stop>
        <stop offset=".11" stopColor="#34C1ED"></stop>
        <stop offset=".23" stopColor="#2FC2DF"></stop>
        <stop offset=".31" stopColor="#2BC3D2"></stop>
        <stop offset=".67" stopColor="#36C752"></stop>
      </radialGradient>
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#66EB6E"></stop>
        <stop offset="1" stopColor="#66EB6E" stopOpacity="0"></stop>
      </radialGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#0C59A4"></stop>
        <stop offset="1" stopColor="#114A8B"></stop>
      </linearGradient>
      <linearGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0" stopColor="#1B9DE2"></stop>
        <stop offset=".16" stopColor="#1595DF"></stop>
        <stop offset=".67" stopColor="#0680D7"></stop>
