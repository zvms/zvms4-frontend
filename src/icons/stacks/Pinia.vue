<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="0.78em" height="1em" viewBox="0 0 256 331">
    ...
    <path
      d="M67.56 173.328c30.366-2.985 41.08-27.648 44.735-64.823c3.654-37.175-21.174-70.814-31.502-69.799c-10.328 1.015-43.15 40.322-46.805 77.497c-3.654 37.175 3.205 60.11 33.572 57.125Z"
      transform="rotate(-38 72.877 106.136)"
    ></path>
    <path
      d="M184.454 186.277c30.367 2.986 36.394-20.032 32.74-57.207c-3.655-37.175-35.645-76.4-45.973-77.415c-10.328-1.015-35.989 32.542-32.334 69.717c3.654 37.175 15.201 61.92 45.567 64.905Z"
      transform="rotate(52 178.34 119.085)"
    ></path>
    <path
      d="M129.232 151.601c27.341 0 34.878-26.184 34.878-67.013c0-40.83-25.579-80.843-34.878-80.843S93.605 43.758 93.605 84.588c0 40.829 8.286 67.013 35.627 67.013Z"
      transform="rotate(7 128.858 77.673)"
    ></path>
    <path
      d="M113.386 330.307c56.896 0 103.038-16.528 103.038-91.482c0-74.955-46.142-136.462-103.038-136.462c-56.897 0-103.002 61.507-103.002 136.462c0 74.954 46.105 91.482 103.002 91.482Z"
    ></path>
    <ellipse cx="165.427" cy="216.677" fill="currentColor" rx="14.717" ry="6.845"></ellipse>
    <ellipse
      cx="57.273"
      cy="212.57"
      fill="currentColor"
