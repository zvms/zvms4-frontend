  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
    <defs>
      <linearGradient id="logosCypressIcon0" x1="6.32%" x2="87.52%" y1="44.028%" y2="58.406%">
        <stop offset="0%" stopColor="#315C55"></stop>
        <stop offset="100%" stopColor="#09293F"></stop>
      </linearGradient>
      <linearGradient id="logosCypressIcon1" x1="54.298%" x2="50%" y1="27.262%" y2="100%">
        <stop offset="0%" stopColor="#4FB38D"></stop>
        <stop offset="100%" stopColor="#315C55"></stop>
      </linearGradient>
      <linearGradient id="logosCypressIcon2" x1="13.909%" x2="70.819%" y1="50%" y2="54.96%">
        <stop offset="0%" stopColor="#4FB38D"></stop>
        <stop offset="100%" stopColor="#97DEC0"></stop>
      </linearGradient>
      <linearGradient id="logosCypressIcon3" x1="53.86%" x2="38.388%" y1="30.892%" y2="95.794%">
        <stop offset="0%" stopColor="#97DEC0"></stop>
        <stop offset="100%" stopColor="ivory" stopOpacity="0"></stop>
        <stop offset="100%" stopColor="ivory" stopOpacity="0"></stop>
      </linearGradient>
    </defs>
    <path
